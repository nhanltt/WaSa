  ...
  if (Firebase.ready() && (millis() - sendDataPrevMillis > 15000 || sendDataPrevMillis == 0))
    {
      ...
      for(i=3;i<=7;i++){
          ...
          Serial.printf("Push int Light 1 ... %s\n", Firebase.pushInt(fbdo, "/Push/Light 1", value[3]) ? "ok" : fbdo.errorReason().c_str());
          Serial.printf("Push int Light 2 ... %s\n", Firebase.pushInt(fbdo, "/Push/Light 2", value[4]) ? "ok" : fbdo.errorReason().c_str());
          Serial.printf("Push int Light 3 ... %s\n", Firebase.pushInt(fbdo, "/Push/Light 3", value[5]) ? "ok" : fbdo.errorReason().c_str());
          Serial.printf("Push int Light 4 ... %s\n", Firebase.pushInt(fbdo, "/Push/Light 4", value[6]) ? "ok" : fbdo.errorReason().c_str());
          Serial.printf("Push int Light 5 ... %s\n", Firebase.pushInt(fbdo, "/Push/Light 5", value[7]) ? "ok" : fbdo.errorReason().c_str());
